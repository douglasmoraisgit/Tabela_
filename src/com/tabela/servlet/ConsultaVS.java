...
/**
 * Servlet implementation class ConsultaVS
 */
@WebServlet("/ConsultaVS")
public class ConsultaVS extends HttpServlet {
	 ...
	 protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
   	...
   	if( chave.length()>10){
			 ...
			 Double grau_cilindrico = Double.parseDouble(cil);
				         ...
				         try {
				         produtos = con.getListaGrau(grau_esferico, grau_cilindrico);
					     request.setAttribute("produtos", produtos);
					     RequestDispatcher view = request.getRequestDispatcher("resposta_visao_simples.jsp");
	         ...
	         Double grau_esferico = Double.parseDouble(esf);
			 Double grau_cilindrico = Double.parseDouble(cil);
			 String grau =""+ grau_esferico+grau_cilindrico;
			             if(grau_cilindrico >0){
			             double Transp_esf = grau_cilindrico+grau_esferico;
			             double Trans_cil = grau_cilindrico*-1;
			             grau_esferico= Transp_esf;
